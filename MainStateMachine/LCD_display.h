...
private:
    ...
    void page_0(U8GLIB_ST7920_128X64_1X u8g,int top_page,int num_trees);
    void page_1(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
    void page_2(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
    void page_3(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
    void page_4(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
    void page_5(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
    void page_6(U8GLIB_ST7920_128X64_1X u8g,int top_page, int num_trees);
